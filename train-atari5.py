...
from tensorpack.RL.pseudocount5 import PSC
...
NUM_ACTIONS = None
ENV_NAME = None
PSC_METHOD = None  # Pseudocount method
...
class MySimulatorWorker(SimulatorProcess):
    def __init__(self, idx, pipe_c2s, pipe_s2c):
        ...
        if PSC_METHOD:
            self.method = PSC_METHOD
            self.psc = PSC(PSC_METHOD, PSC_DOWNSAMPLE_VALUE)
        else:
            self.method = None
...
if __name__ == '__main__':
    ...
    parser.add_argument('--psc', help='pseudocount method', choices=[None, 'joint', 'CTS'], default=None)
    parser.add_argument('--network', help='network architecture', choices=['nature', '1'], default='nature')
    parser.add_argument('--PSC_DOWNSAMPLE_VALUE', help='pseudocount downsample max value', default='128')
